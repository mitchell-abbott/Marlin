...
#define STRING_CONFIG_H_AUTHOR "(Mitchell Abbott, default config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 231.37
  #define  DEFAULT_bedKi 45.55
  #define  DEFAULT_bedKd 293.78
#endif // PIDTEMPBED
...
#define EXTRUDE_MAXLENGTH ((X_MAX_POS - X_MIN_POS) + (Y_MAX_POS - Y_MIN_POS))
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 102.0408 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.91   // Z offset: -below +above  [the nozzle]
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_HOTEND_TEMP  245.0  // (°C) Default nozzle temperature for the G26 Mesh Validation Tool.
